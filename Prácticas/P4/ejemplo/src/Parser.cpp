...
#line 58 "calculadora.yy"
                     { cout << "Análisis léxico y sintáctico terminado.\nEl valor de la expresión ya evaluada es: " << (yystack_[1].value.numero).fval << endl; }
#line 592 "Parser.cpp"
    break;
...
#line 62 "calculadora.yy"
                                    { (yylhs.value.numero).fval = (yystack_[2].value.numero).fval + (yystack_[0].value.numero).fval; }
#line 604 "Parser.cpp"
    break;
...
#line 65 "calculadora.yy"
                              { 
        if((yystack_[0].value.numero).fval == 0) {
            cout << "Error matematico: Division por cero." << endl;
            (yylhs.value.numero).fval = 0;
        } else {
            (yylhs.value.numero).fval = (yystack_[2].value.numero).fval / (yystack_[0].value.numero).fval; 
        }
    }
...
#line 651 "Parser.cpp"
  ...
  Parser::yypact_[] =
  {
      -1,    -4,    -4,    13,    13,    14,    -4,    28,    -4,    20,
      -4,    -4,    -4,    13,    13,    13,    13,    -4,     0,     0,
      -4,    -4
  };
  ...
  Parser::yydefact_[] =
  {
       0,    12,     5,     0,     0,     0,     3,     0,    10,     0,
       1,     2,     4,     0,     0,     0,     0,    11,     6,     7,
       8,     9
  };
  ...
  Parser::yytable_[] =
  {
       8,     9,     1,     2,     0,     3,    11,    15,    16,     4,
      18,    19,    20,    21,    10,     0,     1,     1,     2,     3,
       3,     0,     0,     4,     4,    13,    14,    15,    16,     0,
       0,    17,    12,    13,    14,    15,    16
  };
  ...
  Parser::yycheck_[] =
  {
       3,     4,     3,     4,    -1,     6,     5,     7,     8,    10,
      13,    14,    15,    16,     0,    -1,     3,     3,     4,     6,
       6,    -1,    -1,    10,    10,     5,     6,     7,     8,    -1,
      -1,    11,     4,     5,     6,     7,     8
  };
  ...
  Parser::yystos_[] =
  {
       0,     3,     4,     6,    10,    13,    14,    15,    15,    15,
       0,    14,     4,     5,     6,     7,     8,    11,    15,    15,
      15,    15
  };
  ...
  "MENOS", "MUL", "DIV", "UMINUS", "PARIZQ", "PARDER", "$accept", "lineas",
